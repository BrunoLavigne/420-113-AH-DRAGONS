...
public class Connexion {
    ...
    public Connexion(String serveur,
        ...
        try {
            ...
            {
                d = (Driver) Class.forName("org.postgresql.Driver").newInstance();
                // Ne reconnait pas le driver ODBC, on va probablement flusher ça la semaine prochaine.
            ...
            // TODO ouuuh la belle gestion des erreurs...
        }
    }
    ...
    public void fermer() throws SQLException {
        this.conn.rollback();
        this.conn.close();
        // FIXME ferme la connexion physiquement. pas efficace. Faire une seule connexion qui reste active.
        System.out.println("Connexion ferm�e"
            + " "
            + this.conn);
    }

    // TODO okay... throw une erreur, et on fait quoi avec?
    ...
    public static String serveursSupportes() {
        // TODO Literal Strings. Argh. Utiliser des enums "final"
