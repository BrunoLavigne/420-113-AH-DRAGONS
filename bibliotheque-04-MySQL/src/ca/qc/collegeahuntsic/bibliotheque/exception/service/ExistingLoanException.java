// Fichier ExistingLoanException.java
 ...
 */
public class ExistingLoanException extends Exception {
     ...
     */
    public ExistingLoanException(String message) {
        super(message);
    }
     ...
     * @param cause the cause (which is saved for later retrieval by the {@link Throwable#getCause()} method). (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
     */
    public ExistingLoanException(Throwable cause) {
        super(cause);
    }
     ...
     */
    protected ExistingLoanException(String message,
        Throwable cause,
