// Fichier InvalidLoanLimitException.java
...
/**
 * Cette exception est utilisée en cas de problème avec l'object {@link ca.qc.collegeahuntsic.bibliotheque.service.implementations.Services}.
 *
 * @author Dragons Vicieux
 */
public class InvalidLoanLimitException extends Exception {
    ...
    public InvalidLoanLimitException() {
        super();
    }
     ...
     */
    public InvalidLoanLimitException(String message) {
        super(message);
    }
     ...
     * @param cause the cause (which is saved for later retrieval by the {@link Throwable#getCause()} method). (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
     */
    public InvalidLoanLimitException(Throwable cause) {
        super(cause);
    }
     ...
     */
    protected InvalidLoanLimitException(String message,
        Throwable cause,
