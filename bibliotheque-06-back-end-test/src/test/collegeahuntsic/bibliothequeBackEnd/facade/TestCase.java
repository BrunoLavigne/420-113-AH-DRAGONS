...
public class TestCase extends junit.framework.TestCase {
    ...
    private static final ApplicationContext APPLICATION_CONTEXT = new ClassPathXmlApplicationContext(TestCase.APPLICATION_CONTEXT_FILENAMES);
     ...
     */
    public TestCase() throws TestCaseFailedException {
        super();
        try {
