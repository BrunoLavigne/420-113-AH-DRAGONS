// Fichier InvalidSortByPropertyException.java
...
/**
 * Cette exception est utilisée en cas de problème avec une propriété utilisée pour classer une liste de DTOs.
 *
 * @author Dragons Vicieux
 */
public class InvalidSortByPropertyException extends Exception {
     ...
     */
    public InvalidSortByPropertyException(String message) {
        super(message);
    }
     ...
     */
    public InvalidSortByPropertyException(Throwable cause) {
        super(cause);
    }
