// Fichier DuplicateDTOException.java
...
/**
 * Cette exception est utilisée en cas de duplicat d'un objet {@link ca.qc.collegeahuntsic.bibliothequeBackEnd.dao.implementations.DAO}.
 *
 * @author Dragons Vicieux
 */
public class DuplicateDTOException extends Exception {
     ...
     * @param cause the cause (which is saved for later retrieval by the {@link Throwable#getCause()} method). (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
     */
    public DuplicateDTOException(Throwable cause) {
        super(cause);
    }
     ...
     */
    protected DuplicateDTOException(String message,
        Throwable cause,
